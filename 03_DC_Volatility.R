...
generate_component_analysis(
  component_code = "DC", 
  component_full_name = "Discussion of Character by Others", 
  excel_path = excel_file_path, 
  desktop_dir = desktop_path
)

message("Execution complete. 'DC_Volatility' directory successfully compiled. Figures prefixed with 'DC'.")
